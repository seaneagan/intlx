...
library intlx.iterable.data.KL;

import 'package:intlx/src/iterable/iterable_symbols.dart';
import 'package:intlx/src/cldr_template.dart';

final symbols = new IterableSymbols(start: new SeparatorTemplate(separator: ' aamma '), 
middle: new SeparatorTemplate(separator: ', '), 
end: new SeparatorTemplate(separator: ', '), 
two: new SeparatorTemplate(separator: ' aamma '));
