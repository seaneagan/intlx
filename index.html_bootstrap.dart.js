...
$.init_autogenerated = function() {
  ...
  if (3 >= t2.length)
    throw $.ioore(3);
  t3 = __t.children;
  t3.push($.LoopTemplate$($.$index$asx($.get$nodes$x($.$index$asx($.get$nodes$x(t2[3]), 7)), 1), new $.init_autogenerated_closure(), new $.init_autogenerated_closure0(__html0)));
  __root.get$nodes;
  t2 = $._ChildNodeListLazy$(__root)._this.childNodes;
  if (3 >= t2.length)
    throw $.ioore(3);
  __e10 = $.$index$asx($.get$nodes$x($.$index$asx($.get$nodes$x($.$index$asx($.get$nodes$x(t2[3]), 11)), 1)), 0);
  ...
  if (3 >= t2.length)
    throw $.ioore(3);
  __t.listen$2($.get$onClick$x($.$index$asx($.get$nodes$x($.$index$asx($.get$nodes$x(t2[3]), 15)), 3)), new $.init_autogenerated_closure6());
  __root.get$nodes;
  t2 = $._ChildNodeListLazy$(__root)._this.childNodes;
  if (3 >= t2.length)
    throw $.ioore(3);
  __t.listen$2($.get$onClick$x($.$index$asx($.get$nodes$x($.$index$asx($.get$nodes$x(t2[3]), 15)), 5)), new $.init_autogenerated_closure7());
  __root.get$nodes;
  t2 = $._ChildNodeListLazy$(__root)._this.childNodes;
  if (3 >= t2.length)
    throw $.ioore(3);
  __t.listen$2($.get$onClick$x($.$index$asx($.get$nodes$x($.$index$asx($.get$nodes$x(t2[3]), 15)), 7)), new $.init_autogenerated_closure8());
  __root.get$nodes;
  t2 = $._ChildNodeListLazy$(__root)._this.childNodes;
  if (3 >= t2.length)
    throw $.ioore(3);
  __t.listen$2($.get$onClick$x($.$index$asx($.get$nodes$x(t2[3]), 17)), new $.init_autogenerated_closure9());
  __root.get$nodes;
  t2 = $._ChildNodeListLazy$(__root)._this.childNodes;
  if (3 >= t2.length)
    throw $.ioore(3);
  __t.listen$2($.get$onClick$x($.$index$asx($.get$nodes$x($.$index$asx($.get$nodes$x(t2[3]), 19)), 3)), new $.init_autogenerated_closure10());
  __root.get$nodes;
  t2 = $._ChildNodeListLazy$(__root)._this.childNodes;
  if (3 >= t2.length)
    throw $.ioore(3);
  __t.listen$2($.get$onClick$x($.$index$asx($.get$nodes$x($.$index$asx($.get$nodes$x(t2[3]), 19)), 5)), new $.init_autogenerated_closure11());
  __root.get$nodes;
  t2 = $._ChildNodeListLazy$(__root)._this.childNodes;
  if (3 >= t2.length)
    throw $.ioore(3);
  __t.listen$2($.get$onClick$x($.$index$asx($.get$nodes$x($.$index$asx($.get$nodes$x(t2[3]), 19)), 7)), new $.init_autogenerated_closure12());
  __root.get$nodes;
  t2 = $._ChildNodeListLazy$(__root)._this.childNodes;
  if (3 >= t2.length)
    throw $.ioore(3);
  __e26 = $.$index$asx($.get$nodes$x(t2[3]), 21);
  ...
  if (3 >= t2.length)
    throw $.ioore(3);
  __e29 = $.$index$asx($.get$nodes$x($.$index$asx($.get$nodes$x($.$index$asx($.get$nodes$x(t2[3]), 25)), 1)), 0);
  ...
  if (3 >= t2.length)
    throw $.ioore(3);
  t1.__e30_2 = $.$index$asx($.get$nodes$x($.$index$asx($.get$nodes$x($.$index$asx($.get$nodes$x(t2[3]), 25)), 3)), 0);
  ...
  if (3 >= t2.length)
    throw $.ioore(3);
  __e33 = $.$index$asx($.get$nodes$x($.$index$asx($.get$nodes$x($.$index$asx($.get$nodes$x(t2[3]), 27)), 1)), 0);
  ...
  if (3 >= t2.length)
    throw $.ioore(3);
  t1.__e34_3 = $.$index$asx($.get$nodes$x($.$index$asx($.get$nodes$x($.$index$asx($.get$nodes$x(t2[3]), 27)), 3)), 0);
