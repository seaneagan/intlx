...
DurationFormat: {"": "_RelativeTimeFormat;_liblib9$_length,_locale,_rounder",
  format$1: function(_, duration) {
    ...
    t3 = t1._symbols;
    return t1._format$2(this._liblib9$_length === $.FormatLength_SHORT_0 ? t3.get$shortUnits() : t3.get$units(), t2);
  },
  get$format: function(receiver) {
    return new $.BoundClosure$i1(this, "format$1", receiver);
  },
...
duration: function() {
  ...
  if (t1 == null)
    t1 = t3;
  t1 = new $.DurationFormat(null, new $.RelativeTimeLocale(t2, t1), $.C_DurationRounder);
  t1._liblib9$_length = $.FormatLength_LONG_1;
  if ($._activeObserver != null) {
    t2 = $.get$__changes();
...
AgeComponent_created_autogenerated_closure: {"": "Closure;this_0",
  call$0: function() {
    ...
    t1 = this.this_0;
    if ($._activeObserver != null) {
      t2 = $.get$AgeComponent___changes();
      $._activeObserver._addRead$3(t2, 1, "_dummyCounter");
    }
    t2 = $._activeObserver;
    if (t2 != null)
      t2._addRead$3(t1, 1, "format");
    t2 = t1.get$__$format();
    if (typeof t2 === "object" && t2 !== null && !!$.getInterceptor(t2).$isDurationFormat) {
      t2 = new $.DateTime(Date.now(), false);
      $.Primitives_lazyAsJsDate(t2);
      t3 = $._activeObserver;
      if (t3 != null)
        t3._addRead$3(t1, 1, "value");
      v = $.Duration$(0, 0, 0, $.$sub$n(t2.millisecondsSinceEpoch, t1.get$__$value().get$millisecondsSinceEpoch()), 0, 0);
    } else {
      t2 = $._activeObserver;
      if (t2 != null)
        t2._addRead$3(t1, 1, "value");
      v = t1.get$__$value();
    }
    t2 = $._activeObserver;
    if (t2 != null)
      t2._addRead$3(t1, 1, "format");
    return $.format$1$x(t1.get$__$format(), v);
  },
  $isFunction: true
},
