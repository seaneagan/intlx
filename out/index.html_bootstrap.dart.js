...
$$.ListIterable = {"": "IterableBase;",
  ...
  get$single: function(_) {
    ...
    if ($.$gt$n(this.get$length(this), 1) === true)
      throw $.wrapException($.StateError$("Too many elements"));
    return this.elementAt$1(this, 0);
  },
...
$$.SkipIterable = {"": "IterableBase;_iterable,_skipCount",
  skip$1: function(_, n) {
    ...
    if ($arguments != null && $arguments.constructor === Array)
      ...
      $arguments = typeof $arguments == "function" ? $arguments.apply(null, arguments0) : arguments0;
    t2 = $arguments == null ? null : $arguments[0];
    return $.SkipIterable$(this._iterable, t1, t2);
  },
  get$iterator: function(_) {
    var t1 = this._iterable;
...
$$._BaseSendPort_call_closure = {"": "Closure;completer_0,port_1",
  call$2: function(value, ignoreReplyTo) {
    ...
    $globalState.currentContext.unregister$1(t1._liblib3$_id);
    t1 = this.completer_0;
...
$$.ReceivePortImpl = {"": "Object;_liblib3$_id<,_liblib3$_callback<",
  ...
  ReceivePortImpl$0: function() {
    $.register$2$x($._globalState().currentContext, this._liblib3$_id, this);
  },
  $isReceivePort: true
};
...
$$.Stream_Stream$periodic_sendEvent = {"": "Closure;box_0,watch_1",
  call$0: function() {
    ...
    t1 = t1.controller_3;
    t1.add$1;
    t1.stream._liblib9$_add$1(data);
  },
  $isFunction: true
};
...
$$.Stream_Stream$periodic_closure2 = {"": "Closure;box_0,period_8,watch_9,sendEvent_10,startPeriodicTimer_11",
  call$0: function() {
    ...
    t1 = this.watch_9;
    elapsed = $.Duration$(0, 0, t1.get$elapsedMicroseconds(), 0, 0, 0);
    t1.start$0(t1);
    t1 = this.box_0;
...
$$.Stream_single_closure = {"": "Closure;box_0,this_1,future_2",
  call$1: function(value) {
    ...
    if (t1.foundResult_1) {
      ...
      this.future_2._setError$1($.StateError$("More than one element"));
      return;
    }
...
$$._StreamImpl = {"": "Stream;_state@",
  ...
  _liblib9$_add$1: function(value) {
    ...
    if (t1 != null && t1.get$isEmpty(t1) !== true)
      this._addPendingEvent$1($._DelayedData$(value));
    else
...
$$._ForwardingStreamSubscription = {"": "_BaseStreamSubscription;_stream,_cancelOnError<,_liblib9$_subscription@,_onData,_onError,_onDone",
  cancel$0: function() {
...
$$._HashSetBase = {"": "IterableBase;",
  difference$1: function(other) {
    ...
    for (t1 = this.get$iterator(this), t2 = $.getInterceptor$asx(other); t1.moveNext$0();) {
...
$$.LinkedHashSet = {"": "_HashSetBase;_liblib1$_length,_strings,_nums,_rest,_first,_last,_modifications",
  ...
  get$single: function(_) {
    ...
    throw $.wrapException($.StateError$(this.get$length(this) === 0 ? "No Elements" : "Too many elements"));
  },
  ...
  _newSet$0: function() {
    var $arguments, arguments0, t1;
    $arguments = this.$asLinkedHashSet;
    arguments0 = $.getRuntimeTypeInfo(this);
    if ($arguments != null && $arguments.constructor === Array)
      ;
    else
...
$$._GeneratorIterable = {"": "IterableBase;_liblib10$_count,_generator",
  get$iterator: function(_) {
    return $._GeneratorIterator$(this._liblib10$_count, this._generator);
  },
  $asIterableBase: null,
  $asIterable: null
};

$$._GeneratorIterator = {"": "Object;_liblib10$_count,_generator,_liblib10$_index,_liblib10$_current",
  _generator$1: function(arg0) {
    return this._generator.call$1(arg0);
  },
  moveNext$0: function() {
    var t1 = this._liblib10$_index;
    if (t1 < this._liblib10$_count) {
      this._liblib10$_current = this._generator$1(t1);
...
$$.Stopwatch = {"": "Object;_liblib10$_start,_stop",
  start$0: function(_) {
    var t1 = this._liblib10$_start == null;
    if (!t1 && this._stop == null)
      return;
    if (t1)
      this._liblib10$_start = $.Primitives_numMicroseconds();
    else {
      this._liblib10$_start = $.Primitives_numMicroseconds() - $.$sub$n(this._stop, this._liblib10$_start);
      this._stop = null;
    }
  },
  ...
  stop$0: function(_) {
    if (!(this._liblib10$_start != null && this._stop == null))
      return;
    this._stop = $.Primitives_numMicroseconds();
  },
  reset$0: function(_) {
    if (this._liblib10$_start == null)
      return;
    this._liblib10$_start = $.Primitives_numMicroseconds();
    if (this._stop != null)
      this._stop = this._liblib10$_start;
  },
  get$elapsedTicks: function() {
    var t1, t2;
    t1 = this._liblib10$_start;
    if (t1 == null)
      return 0;
    t2 = this._stop;
    return t2 == null ? $.$sub$n($.Stopwatch__now(), this._liblib10$_start) : $.$sub$n(t2, t1);
  },
...
$$._EventStreamSubscription = {"": "StreamSubscription;_liblib11$_pauseCount,_target,_eventType,_liblib11$_onData,_useCapture",
  cancel$0: function() {
    var t1, t2;
    t1 = this._target;
    if (t1 == null)
      return;
    t2 = this._liblib11$_onData;
    if (t2 != null)
      $.$$dom_removeEventListener$3$x(t1, this._eventType, t2, this._useCapture);
    this._target = null;
    this._liblib11$_onData = null;
  },
  _tryResume$0: function() {
    var t1 = this._liblib11$_onData;
    if (t1 != null && this._liblib11$_pauseCount <= 0)
...
$$._WrappedList = {"": "ListBase;_liblib11$_list",
  get$iterator: function(_) {
    return $._WrappedIterator$($.get$iterator$ax(this._liblib11$_list));
  },
  get$length: function(_) {
    return this._liblib11$_list.length;
  },
  add$1: function(_, element) {
    $.add$1$ax(this._liblib11$_list, element);
  },
  remove$1: function(_, element) {
    $.remove$1$ax(this._liblib11$_list, element);
  },
  clear$0: function(_) {
    $.clear$0$ax(this._liblib11$_list);
  },
  $index: function(_, index) {
  ...
  set$length: function(_, newLength) {
    $.set$length$asx(this._liblib11$_list, newLength);
  },
  setRange$4: function(_, start, end, iterable, skipCount) {
    $.setRange$4$ax(this._liblib11$_list, start, end, iterable, skipCount);
  },
  $asListBase: null,
  $asList: null,
  $asIterable: null
...
$$._WrappedIterator = {"": "Object;_liblib11$_iterator",
  moveNext$0: function() {
    return this._liblib11$_iterator.moveNext$0();
  },
  get$current: function() {
    return this._liblib11$_iterator.get$current();
  }
};
...
$$.CssClassSetImpl = {"": "Object;",
  ...
  difference$1: function(other) {
    return this.readClasses$0().difference$1(other);
  },
  get$first: function(_) {
    var t1 = this.readClasses$0();
...
$$._AttributeClassSet = {"": "CssClassSetImpl;_liblib12$_element",
  readClasses$0: function() {
    ...
    classname = $._ElementAttributeMap$(this._liblib12$_element)._element.getAttribute("class");
    s = $.LinkedHashSet$($.JSString);
    if (classname == null)
      return s;
  ...
  writeClasses$1: function(s) {
    $._ElementAttributeMap$(this._liblib12$_element)._element.setAttribute("class", s.join$1(s, " "));
  }
};
...
$$.closure1 = {"": "Closure;",
  call$2: function(filtered, locale) {
    var languageLocale, t1;
    languageLocale = $.Intl_verifiedLocale(locale, $.get$_localeNames().get$containsKey(), new $._closure());
...
$$.AgeComponent = {"": "WebComponent_Observable;__t,__$value,__$format,$$_observers,$$_changes,hashCode,_host,_shadowRoots,_generatedRoots",
  created_autogenerated$0: function() {
    ...
    __binding35 = this.__t.contentBind$2(new $.AgeComponent_created_autogenerated_closure(this), false);
...
$$.AgeComponent_created_autogenerated_closure = {"": "Closure;this_0",
  call$0: function() {
    ...
    t3 = t2.get$format(t1);
    v = typeof t3 === "object" && t3 !== null && !!$.getInterceptor(t3).$isDurationFormat ? $.DateTime_DateTime$now().difference$1(t2.get$value(t1)) : t2.get$value(t1);
    return $.format$1$x(t2.get$format(t1), v);
  },
  $isFunction: true
};
...
$$.sod_closure = {"": "Closure;",
  call$1: function(now) {
    return $.DateTime$_internal(now.get$year(), now.get$month(), now.get$day(), 0, 0, 0, 0, false);
  },
  $isFunction: true
};
...
$$.som_closure = {"": "Closure;",
  call$1: function(now) {
    return $.DateTime$_internal(now.get$year(), now.get$month(), 1, 0, 0, 0, 0, false);
  },
  $isFunction: true
};
...
$$.soy_closure = {"": "Closure;",
  call$1: function(now) {
    return $.DateTime$_internal(now.get$year(), 1, 1, 0, 0, 0, 0, false);
  },
  $isFunction: true
};
...
$$.eod_closure = {"": "Closure;",
  call$1: function(now) {
    return $.DateTime$_internal(now.get$year(), now.get$month(), now.get$day() + 1, 0, 0, 0, 0, false);
  },
  $isFunction: true
};
...
$$.eom_closure = {"": "Closure;",
  call$1: function(now) {
    return $.DateTime$_internal(now.get$year(), now.get$month() + 1, 1, 0, 0, 0, 0, false);
  },
  $isFunction: true
};
...
$$.eoy_closure = {"": "Closure;",
  call$1: function(now) {
    return $.DateTime$_internal(now.get$year() + 1, 1, 1, 0, 0, 0, 0, false);
  },
  $isFunction: true
};
  ...
  call$1: function(locale) {
    ...
    if (foundLocale != null) {
      if ($.hasObservers($.get$__changes()))
        $.notifyChange($.get$__changes(), 1, "selectedLocale", $.__$selectedLocale, foundLocale);
      $.__$selectedLocale = foundLocale;
...
$$.init_autogenerated_closure = {"": "Closure;",
  call$0: function() {
    return $.get$localeNames().get$keys();
  },
  $isFunction: true
};
...
$$.init_autogenerated_closure0 = {"": "Closure;__html0_1",
  call$3: function($$list, $$index, __t) {
    var locale, __e2, __e1, __binding0, t1;
    locale = $.$index$asx($$list, $$index);
    __e2 = $.clone$1$x(this.__html0_1, true);
    __e1 = $.$index$asx($.get$nodes$x(__e2), 0);
    __binding0 = __t.contentBind$2(new $.init_autogenerated__closure(locale), false);
    t1 = $.getInterceptor$x(__e1);
    $.add$1$ax(t1.get$nodes(__e1), __binding0);
    __t.listen$2(t1.get$onClick(__e1), new $.init_autogenerated__closure0(locale));
    __t.bindClass$3(__e2, new $.init_autogenerated__closure1(locale), false);
...
$$.init_autogenerated__closure = {"": "Closure;locale_2",
  call$0: function() {
    return $.$index$asx($.get$localeNames(), this.locale_2);
  },
  $isFunction: true
};
...
$$.init_autogenerated__closure0 = {"": "Closure;locale_3",
  call$1: function($$event) {
    ...
    if ($.hasObservers($.get$__changes()))
      $.notifyChange($.get$__changes(), 1, "selectedLocale", $.__$selectedLocale, t1);
    $.__$selectedLocale = t1;
  },
  $isFunction: true
};
...
$$.init_autogenerated__closure1 = {"": "Closure;locale_4",
  call$0: function() {
    if ($.observeReads())
      $.notifyRead($.get$__changes(), 1, "selectedLocale");
    return $.$eq(this.locale_4, $.__$selectedLocale) === true ? "active" : "";
  },
  $isFunction: true
};
...
$$.init_autogenerated_closure2 = {"": "Closure;",
  call$0: function() {
    var t1 = $.IterableFormat$($.selectedLocale(), $.noop$closure);
...
$$.init_autogenerated_closure5 = {"": "Closure;",
  call$0: function() {
    var t1 = $.IterableFormat$($.selectedLocale(), $.noop$closure);
    return t1.format$1(t1, $.range(3, 1, 1));
  },
  $isFunction: true
};
...
$$.init_autogenerated_closure16 = {"": "Closure;box_0",
  call$1: function($$event) {
    var t1 = $.get$value$x(this.box_0.__e21_0);
    if ($.hasObservers($.get$__changes()))
...
$$.init_autogenerated_closure18 = {"": "Closure;box_0",
  call$1: function(e) {
    var t1 = this.box_0;
    if ($.$eq($.get$value$x(t1.__e21_0), e) !== true)
      $.set$value$x(t1.__e21_0, e);
  },
  $isFunction: true
};
...
$$.init_autogenerated_closure19 = {"": "Closure;box_0",
  call$1: function($$event) {
    var t1 = $.get$value$x(this.box_0.__e23_1);
    if ($.hasObservers($.get$__changes()))
...
$$.init_autogenerated_closure21 = {"": "Closure;box_0",
  call$1: function(e) {
    var t1 = this.box_0;
    if ($.$eq($.get$value$x(t1.__e23_1), e) !== true)
      $.set$value$x(t1.__e23_1, e);
  },
  $isFunction: true
};
...
$$.init_autogenerated_closure26 = {"": "Closure;box_0",
  call$1: function(e) {
    var t1 = this.box_0;
    if ($.$eq($.get$format$x($.get$xtag$x(t1.__e30_2)), e) !== true)
      $.set$format$x($.get$xtag$x(t1.__e30_2), e);
  },
  $isFunction: true
};
...
$$.init_autogenerated_closure28 = {"": "Closure;box_0",
  call$1: function(e) {
    var t1 = this.box_0;
    if ($.$eq($.get$value$x($.get$xtag$x(t1.__e30_2)), e) !== true)
      $.set$value$x($.get$xtag$x(t1.__e30_2), e);
  },
  $isFunction: true
};
...
$$.init_autogenerated_closure32 = {"": "Closure;box_0",
  call$1: function(e) {
    var t1 = this.box_0;
    if ($.$eq($.get$format$x($.get$xtag$x(t1.__e34_3)), e) !== true)
      $.set$format$x($.get$xtag$x(t1.__e34_3), e);
  },
  $isFunction: true
};
...
$$.init_autogenerated_closure34 = {"": "Closure;box_0",
  call$1: function(e) {
    var t1 = this.box_0;
    if ($.$eq($.get$value$x($.get$xtag$x(t1.__e34_3)), e) !== true)
      $.set$value$x($.get$xtag$x(t1.__e34_3), e);
  },
  $isFunction: true
};
...
$$.IterableLocale = {"": "Object;_liblib13$_symbols<,_onSeparator<",
  format$1: function(_, iterable) {
    var t1, list, $length;
  ...
  _formatAll$1: function(list) {
    var t1, $length, t2, t3, t4, result;
    t1 = $.getInterceptor$asx(list);
    $length = t1.get$length(list);
    t2 = this._liblib13$_symbols;
    ...
    if (t3.$gt($length, 2) === true) {
      ...
      result = $.fold$2$ax($.skip$1$ax($.get$reversed$ax(t3 ? $.toList$0$ax(t1.skip$1(list, 1)) : list), 2), result, new $.IterableLocale__formatAll_closure(this));
      if (t3)
...
$$.IterableLocale__formatAll_closure = {"": "Closure;this_0",
  call$2: function(result, item) {
    var t1 = this.this_0;
    return $.renderCldrTemplate(t1.get$_liblib13$_symbols().get$middle(), [item, result], t1.get$_onSeparator());
  },
  $isFunction: true
};
...
$$.PluralFormat = {"": "Object;_cases,_liblib7$_pattern,_locale",
    ...
    if (t1.containsKey$1(quantityString) === true)
      ...
      if (t1.containsKey$1(category) === true)
        ...
        if (t1.containsKey$1("other") === true)
          ...
          throw $.wrapException($._ExceptionImplementation$("No case found for quantity: " + $.S(quantity)));
        key = "other";
      }
    }
    template = $.$index$asx(t1, key);
    return $.splitMapJoin$2$onMatch$s(template, this._liblib7$_pattern, new $.PluralFormat_format_closure(quantityString));
  },
  get$format: function(receiver) {
    return new $.BoundClosure$i1(this, "format$1", receiver);
  }
...
$$.AgeFormat = {"": "_RelativeTimeFormat;_locale,_rounder",
  format$1: function(_, date) {
    var milliseconds, t1, age, isFuture, t2, t3;
    milliseconds = $.$sub$n($.DateTime$_now().millisecondsSinceEpoch, date.get$millisecondsSinceEpoch());
...
$$.RelativeTimeLocale = {"": "Object;_symbols,_liblib6$_locale",
  _format$2: function(units, roundDuration) {
    var pluralFormat = $.PluralFormat$(units.$index(units, $.toString$0(roundDuration.unit)), this._liblib6$_locale, "{0}");
...
$$.TimeUnit = {"": "Object;_name,_liblib7$_index<",
  compareTo$1: function(_, other) {
    return $.JSInt_methods.compareTo$1(this._liblib7$_index, other.get$_liblib7$_index());
  },
  toString$0: function(_) {
    return this._name;
  }
...
$$.SymbolsMap = {"": "Object;_localeList,_liblib8$_map",
  ...
  $index: function(_, locale) {
    ...
    if (t1.containsKey$1(locale) !== true)
      throw $.wrapException($.LocaleDataException$("Locale data has not been loaded for locale: '" + $.S(locale) + "'"));
...
$.stringReplaceAllEmptyFuncUnchecked = function(receiver, onMatch, onNonMatch) {
  ...
  buffer._contents = buffer._contents + str;
  for (i = 0; i < $length;) {
    str = onMatch.call$1($.StringMatch$(i, receiver, ""));
    str = typeof str === "string" ? str : $.S(str);
    buffer._contents = buffer._contents + str;
    if (i >= $length)
      $.throwExpression($.RangeError$value(i));
    if ((receiver.charCodeAt(i) & 4294966272) >>> 0 === 55296 && $length > i + 1) {
      t1 = i + 1;
      if (t1 >= $length)
        $.throwExpression($.RangeError$value(t1));
...
$.stringReplaceAllStringFuncUnchecked = function(receiver, pattern, onMatch, onNonMatch) {
  ...
  for (startIndex = 0; startIndex < $length;) {
    ...
    str = typeof str === "string" ? str : $.S(str);
    buffer._contents = buffer._contents + str;
    str = onMatch.call$1($.StringMatch$(position, receiver, pattern));
    str = typeof str === "string" ? str : $.S(str);
    buffer._contents = buffer._contents + str;
...
$.Stream_Stream$periodic = function(period, computation, T) {
  ...
  t1.controller_3 = $.StreamController$(new $.Stream_Stream$periodic_closure(t1), new $.Stream_Stream$periodic_closure0(watch, t3), new $.Stream_Stream$periodic_closure1(t1, watch), new $.Stream_Stream$periodic_closure2(t1, period, watch, t2, t3), T);
...
$._GeneratorIterator$ = function(_count, _generator) {
  return new $._GeneratorIterator(_count, _generator, 0, null);
};
...
$.durationFormat = function() {
  return $.DurationFormat$($.FormatLength_LONG_1, $.selectedLocale(), $.C_DurationRounder);
};
...
$.sod = function() {
  return new $.sod_closure().call$1($.DateTime$_now());
};

$.som = function() {
  return new $.som_closure().call$1($.DateTime$_now());
};

$.soy = function() {
  return new $.soy_closure().call$1($.DateTime$_now());
};

$.eod = function() {
  return new $.eod_closure().call$1($.DateTime$_now());
};

$.eom = function() {
  return new $.eom_closure().call$1($.DateTime$_now());
};

$.eoy = function() {
  return new $.eoy_closure().call$1($.DateTime$_now());
};

$.main = function() {
  if ($.observeReads())
    $.notifyRead($.get$__changes(), 1, "relativeTimeData");
  var t1 = $.get$__$relativeTimeData();
  t1.load$0(t1);
  if ($.observeReads())
    $.notifyRead($.get$__changes(), 1, "iterableData");
  t1 = $.get$__$iterableData();
  t1.load$0(t1);
  if ($.observeReads())
    $.notifyRead($.get$__changes(), 1, "pluralData");
  t1 = $.get$__$pluralData();
  t1.load$0(t1);
  t1 = window.navigator;
  t1.get$language;
  $.Intl_systemLocale = $.Intl_canonicalizedLocale(t1.language || t1.userLanguage);
  $._FutureImpl$immediate($.Intl_systemLocale, null).then$1(new $.main_closure());
};

$.init_autogenerated = function() {
  var t1, __root, __html0, __html1, __html10, __html11, __html2, __html3, __html4, __html5, __html6, __html7, __html8, __html9, __t, t2, t3, __e10, __binding4, __e6, __binding5, __binding7, __binding8, __binding9, __e26, __binding18, __binding19, __binding20, __e22, __e24, __binding25, __e29, __binding27, __binding28, __e33, __binding31, __binding32;
  t1 = {};
  __root = document.body;
  __html0 = $._ElementFactoryProvider_createElement_html("<li class=\"\"><a href=\"#_\"></a></li>");
  __html1 = $._ElementFactoryProvider_createElement_html("<b>\"</b>");
  __html10 = $._ElementFactoryProvider_createElement_html("<span class=\"controls\"><select class=\"span2\"><option value=\"0\">seconds</option><option value=\"1\">minutes</option><option value=\"2\">hours</option><option value=\"3\">days</option></select></span>");
  __html11 = $._ElementFactoryProvider_createElement_html("<span class=\"controls\"><input type=\"number\" class=\"input-mini\"></span>");
  ...
  __html7 = $._ElementFactoryProvider_createElement_html("<span style=\"float: right\"></span>");
  ...
  if (3 >= t2.length)
    throw $.ioore(3);
  t3 = __t.children;
  t3.push($.LoopTemplate$($.$index$asx($.get$nodes$x($.$index$asx($.get$nodes$x(t2[3]), 5)), 1), new $.init_autogenerated_closure(), new $.init_autogenerated_closure0(__html0)));
  __root.get$nodes;
  t2 = $._ChildNodeListLazy$(__root)._this.childNodes;
  if (3 >= t2.length)
    throw $.ioore(3);
  __e10 = $.$index$asx($.get$nodes$x($.$index$asx($.get$nodes$x($.$index$asx($.get$nodes$x(t2[3]), 9)), 1)), 0);
  __binding4 = __t.contentBind$2(new $.init_autogenerated_closure1(), false);
  __e6 = $.clone$1$x(__html7, true);
  __binding5 = __t.contentBind$2(new $.init_autogenerated_closure2(), false);
  $.addAll$1$ax($.get$nodes$x(__e6), [$.clone$1$x(__html8, true), __binding5, $.clone$1$x(__html9, true)]);
  __binding7 = __t.contentBind$2(new $.init_autogenerated_closure3(), false);
  __binding8 = __t.contentBind$2(new $.init_autogenerated_closure4(), false);
  __binding9 = __t.contentBind$2(new $.init_autogenerated_closure5(), false);
  $.addAll$1$ax($.get$nodes$x(__e10), [document.createTextNode("var iterableFormat = new IterableFormat(locale: \""), __binding4, document.createTextNode("\");\niterableFormat.format([]) "), __e6, document.createTextNode("\niterableFormat.format([1]) -> "), $.clone$1$x(__html1, true), __binding7, $.clone$1$x(__html2, true), document.createTextNode("\niterableFormat.format([1, 2]) -> "), $.clone$1$x(__html3, true), __binding8, $.clone$1$x(__html4, true), document.createTextNode("\niterableFormat.format([1, 2, 3]) -> "), $.clone$1$x(__html5, true), __binding9, $.clone$1$x(__html6, true)]);
  __root.get$nodes;
  t2 = $._ChildNodeListLazy$(__root)._this.childNodes;
  if (3 >= t2.length)
    throw $.ioore(3);
  __t.listen$2($.get$onClick$x($.$index$asx($.get$nodes$x($.$index$asx($.get$nodes$x(t2[3]), 13)), 3)), new $.init_autogenerated_closure6());
  __root.get$nodes;
  t2 = $._ChildNodeListLazy$(__root)._this.childNodes;
  if (3 >= t2.length)
    throw $.ioore(3);
  __t.listen$2($.get$onClick$x($.$index$asx($.get$nodes$x($.$index$asx($.get$nodes$x(t2[3]), 13)), 5)), new $.init_autogenerated_closure7());
  __root.get$nodes;
  t2 = $._ChildNodeListLazy$(__root)._this.childNodes;
  if (3 >= t2.length)
    throw $.ioore(3);
  __t.listen$2($.get$onClick$x($.$index$asx($.get$nodes$x($.$index$asx($.get$nodes$x(t2[3]), 13)), 7)), new $.init_autogenerated_closure8());
  __root.get$nodes;
  t2 = $._ChildNodeListLazy$(__root)._this.childNodes;
  if (3 >= t2.length)
    throw $.ioore(3);
  __t.listen$2($.get$onClick$x($.$index$asx($.get$nodes$x(t2[3]), 15)), new $.init_autogenerated_closure9());
  __root.get$nodes;
  t2 = $._ChildNodeListLazy$(__root)._this.childNodes;
  if (3 >= t2.length)
    throw $.ioore(3);
  __t.listen$2($.get$onClick$x($.$index$asx($.get$nodes$x($.$index$asx($.get$nodes$x(t2[3]), 17)), 3)), new $.init_autogenerated_closure10());
  __root.get$nodes;
  t2 = $._ChildNodeListLazy$(__root)._this.childNodes;
  if (3 >= t2.length)
    throw $.ioore(3);
  __t.listen$2($.get$onClick$x($.$index$asx($.get$nodes$x($.$index$asx($.get$nodes$x(t2[3]), 17)), 5)), new $.init_autogenerated_closure11());
  __root.get$nodes;
  t2 = $._ChildNodeListLazy$(__root)._this.childNodes;
  if (3 >= t2.length)
    throw $.ioore(3);
  __t.listen$2($.get$onClick$x($.$index$asx($.get$nodes$x($.$index$asx($.get$nodes$x(t2[3]), 17)), 7)), new $.init_autogenerated_closure12());
  __root.get$nodes;
  t2 = $._ChildNodeListLazy$(__root)._this.childNodes;
  if (3 >= t2.length)
    throw $.ioore(3);
  __e26 = $.$index$asx($.get$nodes$x(t2[3]), 19);
  __binding18 = __t.contentBind$2(new $.init_autogenerated_closure13(), false);
  __binding19 = __t.contentBind$2(new $.init_autogenerated_closure14(), false);
  __binding20 = __t.contentBind$2(new $.init_autogenerated_closure15(), false);
  __e22 = $.clone$1$x(__html10, true);
  t1.__e21_0 = $.$index$asx($.get$nodes$x(__e22), 0);
  __t.listen$2($.get$onChange$x(t1.__e21_0), new $.init_autogenerated_closure16(t1));
  t3.push($.DomPropertyBinding$(new $.init_autogenerated_closure17(), new $.init_autogenerated_closure18(t1), false, false));
  __e24 = $.clone$1$x(__html11, true);
  t1.__e23_1 = $.$index$asx($.get$nodes$x(__e24), 0);
  __t.listen$2($.get$onInput$x(t1.__e23_1), new $.init_autogenerated_closure19(t1));
  t3.push($.DomPropertyBinding$(new $.init_autogenerated_closure20(), new $.init_autogenerated_closure21(t1), false, false));
  __binding25 = __t.contentBind$2(new $.init_autogenerated_closure22(), false);
  $.addAll$1$ax($.get$nodes$x(__e26), [document.createTextNode("var durationFormat = new DurationFormat(locale: \""), __binding18, document.createTextNode("\");\nvar defaultAgeFormat = new AgeFormat(locale: \""), __binding19, document.createTextNode("\");\nvar secondsAgeFormat = new AgeFormat(locale: \""), __binding20, document.createTextNode("\", rounder: new DurationRounder.staticUnit(TimeUnit.SECOND));\nvar duration = new Duration("), __e22, document.createTextNode(": "), __e24, document.createTextNode(");\ndurationFormat.format(duration) "), __binding25, document.createTextNode("\n")]);
  __root.get$nodes;
  t2 = $._ChildNodeListLazy$(__root)._this.childNodes;
  if (3 >= t2.length)
    throw $.ioore(3);
  __e29 = $.$index$asx($.get$nodes$x($.$index$asx($.get$nodes$x($.$index$asx($.get$nodes$x(t2[3]), 23)), 1)), 0);
  __binding27 = __t.contentBind$2(new $.init_autogenerated_closure23(), false);
  __binding28 = __t.contentBind$2(new $.init_autogenerated_closure24(), false);
  $.addAll$1$ax($.get$nodes$x(__e29), [document.createTextNode("<intlx-age \n  value=\""), __binding27, document.createTextNode("\" \n  format=\""), __binding28, document.createTextNode("\">\n</intlx-age>")]);
  __root.get$nodes;
  t2 = $._ChildNodeListLazy$(__root)._this.childNodes;
  if (3 >= t2.length)
    throw $.ioore(3);
  t1.__e30_2 = $.$index$asx($.get$nodes$x($.$index$asx($.get$nodes$x($.$index$asx($.get$nodes$x(t2[3]), 23)), 3)), 0);
  t3.push($.DomPropertyBinding$(new $.init_autogenerated_closure25(), new $.init_autogenerated_closure26(t1), false, false));
  t3.push($.DomPropertyBinding$(new $.init_autogenerated_closure27(), new $.init_autogenerated_closure28(t1), false, false));
  t2 = $.AgeComponent$();
  t2.set$host(t2, t1.__e30_2);
  t3.push($.ComponentItem$(t2));
  __root.get$nodes;
  t2 = $._ChildNodeListLazy$(__root)._this.childNodes;
  if (3 >= t2.length)
    throw $.ioore(3);
  __e33 = $.$index$asx($.get$nodes$x($.$index$asx($.get$nodes$x($.$index$asx($.get$nodes$x(t2[3]), 25)), 1)), 0);
  __binding31 = __t.contentBind$2(new $.init_autogenerated_closure29(), false);
  __binding32 = __t.contentBind$2(new $.init_autogenerated_closure30(), false);
  $.addAll$1$ax($.get$nodes$x(__e33), [document.createTextNode("<intlx-age \n  value=\""), __binding31, document.createTextNode("\" \n  format=\""), __binding32, document.createTextNode("\">\n</intlx-age>")]);
  __root.get$nodes;
  t2 = $._ChildNodeListLazy$(__root)._this.childNodes;
  if (3 >= t2.length)
    throw $.ioore(3);
  t1.__e34_3 = $.$index$asx($.get$nodes$x($.$index$asx($.get$nodes$x($.$index$asx($.get$nodes$x(t2[3]), 25)), 3)), 0);
  t3.push($.DomPropertyBinding$(new $.init_autogenerated_closure31(), new $.init_autogenerated_closure32(t1), false, false));
  t3.push($.DomPropertyBinding$(new $.init_autogenerated_closure33(), new $.init_autogenerated_closure34(t1), false, false));
  t2 = $.AgeComponent$();
  t2.set$host(t2, t1.__e34_3);
  t3.push($.ComponentItem$(t2));
  __t.create$0();
  __t.insert$0(__t);
};
...
$.renderCldrTemplate = function(template, elements, staticSegmentTransform) {
  return $.join$0$ax($.map$1$ax(template, new $.renderCldrTemplate_closure(elements, staticSegmentTransform)));
};
...
$.IterableSymbols$ = function(end, indexed, middle, start) {
  var t1 = $.ifNull($.ifNull(start, middle), []);
  return new $.IterableSymbols($.ifNull(middle, []), t1, $.ifNull($.ifNull(end, middle), []), indexed);
};
...
$.ifEmpty = function(v, d) {
  return v._liblib1$_length === 0 ? d : v;
};

$.range = function($length, start, step) {
  return $._GeneratorIterable$($length, new $.range_closure(start, step), null);
};
...
Isolate.$lazy($, "localeNames", "localeNames", "get$localeNames", function() {
  var t1 = $.JSArray_methods.where$1($.locales(), new $.closure0());
  return t1.fold$2(t1, $.makeLiteralMap([]), new $.closure1());
});
Isolate.$lazy($, "_localeNames", "_localeNames", "get$_localeNames", function() {
...
Isolate.$lazy($, "__$dateTime", "__$dateTime", "get$__$dateTime", function() {
  return $.add$1$ax($.DateTime_DateTime$now(), $.Duration_30000000);
});
...
Isolate.$lazy($, "map", "PluralLocaleImpl_map", "get$PluralLocaleImpl_map", function() {
  return $.SymbolsMap$($.List_Hl6, null);
});
...
Isolate.$lazy($, "ALL", "ALL1", "get$ALL1", function() {
  return $.AllLocaleDataImpl$(new $.closure176());
});
