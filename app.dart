...
void init_autogenerated() {
  ...
  var __e1, __e10, __e12, __e13, __e16, __e17, __e19, __e21, __e23, __e25, __e27, __e29, __e31, __e5, __e6, __e7, __e9;
  ...
  __e6 = __root.nodes[3].nodes[7].nodes[1].nodes[1].nodes[7].nodes[1].nodes[1].nodes[1];
  __t.listen(__e6.onChange, ($event) { timeUnit = __e6.value; });
  __t.oneWayBind(() => timeUnit, (e) { if (__e6.value != e) __e6.value = e; }, false, false);
  __e7 = __root.nodes[3].nodes[7].nodes[1].nodes[1].nodes[7].nodes[1].nodes[5].nodes[1];
  ...
  __e9 = __root.nodes[3].nodes[7].nodes[1].nodes[1].nodes[9].nodes[3];
  var __binding8 = __t.contentBind(() => duration, false);
  __e9.nodes.addAll([__html2.clone(true),
      __binding8,
      __html3.clone(true)]);
  __e10 = __root.nodes[3].nodes[7].nodes[1].nodes[1].nodes[13].nodes[1].nodes[2].nodes[0];
  __t.listen(__e10.onChange, ($event) { selectedTime = __e10.value; });
  __t.oneWayBind(() => selectedTime, (e) { if (__e10.value != e) __e10.value = e; }, false, false);
  __e12 = __root.nodes[3].nodes[7].nodes[1].nodes[1].nodes[21].nodes[1].nodes[0];
  var __binding11 = __t.contentBind(() => mustachify('dateTime'), false);
  __e12.nodes.addAll([new autogenerated.Text('<intlx-age \n  value="'),
      __binding11,
      new autogenerated.Text('" \n</intlx-age>')]);
  __e13 = __root.nodes[3].nodes[7].nodes[1].nodes[1].nodes[21].nodes[3].nodes[0];
  __t.oneWayBind(() => defaultAgeFormat, (e) { if (__e13.xtag.format != e) __e13.xtag.format = e; }, false, false);
  __t.oneWayBind(() => dateTime, (e) { if (__e13.xtag.value != e) __e13.xtag.value = e; }, false, false);
  __t.component(new AgeComponent()..host = __e13);
  __e16 = __root.nodes[3].nodes[7].nodes[1].nodes[1].nodes[23].nodes[1].nodes[0];
  var __binding14 = __t.contentBind(() => mustachify('dateTime'), false);
  var __binding15 = __t.contentBind(() => mustachify('ageFormat'), false);
  __e16.nodes.addAll([new autogenerated.Text('<intlx-age \n  value="'),
      __binding14,
      new autogenerated.Text('" \n  format="'),
      __binding15,
      new autogenerated.Text('">\n</intlx-age>')]);
  __e17 = __root.nodes[3].nodes[7].nodes[1].nodes[1].nodes[23].nodes[3].nodes[0];
  __t.oneWayBind(() => secondsAgeFormat, (e) { if (__e17.xtag.format != e) __e17.xtag.format = e; }, false, false);
  __t.oneWayBind(() => dateTime, (e) { if (__e17.xtag.value != e) __e17.xtag.value = e; }, false, false);
  __t.component(new AgeComponent()..host = __e17);
  __e19 = __root.nodes[3].nodes[7].nodes[3].nodes[1].nodes[5].nodes[3];
  var __binding18 = __t.contentBind(() => formatCount(0), false);
  __e19.nodes.addAll([__html4.clone(true),
      __binding18,
      __html5.clone(true)]);
  __e21 = __root.nodes[3].nodes[7].nodes[3].nodes[1].nodes[7].nodes[3];
  var __binding20 = __t.contentBind(() => formatCount(1), false);
  __e21.nodes.addAll([__html6.clone(true),
      __binding20,
      __html7.clone(true)]);
  __e23 = __root.nodes[3].nodes[7].nodes[3].nodes[1].nodes[9].nodes[3];
  var __binding22 = __t.contentBind(() => formatCount(2), false);
  __e23.nodes.addAll([__html8.clone(true),
      __binding22,
      __html9.clone(true)]);
  __e25 = __root.nodes[3].nodes[7].nodes[3].nodes[1].nodes[11].nodes[3];
  var __binding24 = __t.contentBind(() => formatCount(5), false);
  __e25.nodes.addAll([__html10.clone(true),
      __binding24,
      __html11.clone(true)]);
  __e27 = __root.nodes[3].nodes[7].nodes[3].nodes[1].nodes[17].nodes[3];
  var __binding26 = __t.contentBind(() => pluralFormat.format(0), false);
  __e27.nodes.addAll([__html12.clone(true),
      __binding26,
      __html13.clone(true)]);
  __e29 = __root.nodes[3].nodes[7].nodes[3].nodes[1].nodes[19].nodes[3];
  var __binding28 = __t.contentBind(() => pluralFormat.format(1), false);
  __e29.nodes.addAll([__html14.clone(true),
      __binding28,
      __html15.clone(true)]);
  __e31 = __root.nodes[3].nodes[7].nodes[3].nodes[1].nodes[21].nodes[3];
  var __binding30 = __t.contentBind(() => pluralFormat.format(2), false);
  __e31.nodes.addAll([__html16.clone(true),
      __binding30,
      __html17.clone(true)]);
  __t.create();
  __t.insert();
